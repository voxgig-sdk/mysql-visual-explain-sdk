...
// MysqlVisualExplain SDK audit feature
...
class MysqlVisualExplainAuditFeature extends MysqlVisualExplainBaseFeature
{
    ...
    private function _emit(MysqlVisualExplainContext $ctx, string $outcome): void
    {
