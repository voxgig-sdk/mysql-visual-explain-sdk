...
// MysqlVisualExplain SDK debug feature
...
class MysqlVisualExplainDebugFeature extends MysqlVisualExplainBaseFeature
{
    ...
    private function _finish(MysqlVisualExplainContext $ctx, bool $ok): void
    {
