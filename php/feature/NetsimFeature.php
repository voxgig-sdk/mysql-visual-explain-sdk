...
// MysqlVisualExplain SDK netsim feature
...
class MysqlVisualExplainNetsimFeature extends MysqlVisualExplainBaseFeature
{
    ...
    private function _simulate(MysqlVisualExplainContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MysqlVisualExplainContext $ctx, array $applied): void
    {
        $client = $this->client;
