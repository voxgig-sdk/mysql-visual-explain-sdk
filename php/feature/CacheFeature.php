...
// MysqlVisualExplain SDK cache feature
...
class MysqlVisualExplainCacheFeature extends MysqlVisualExplainBaseFeature
{
    ...
    private function _through(MysqlVisualExplainContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
