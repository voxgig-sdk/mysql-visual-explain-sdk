...
// MysqlVisualExplain SDK telemetry feature
...
class MysqlVisualExplainTelemetryFeature extends MysqlVisualExplainBaseFeature
{
    ...
    private function _close(MysqlVisualExplainContext $ctx, bool $ok): void
    {
