...
// MysqlVisualExplain SDK clienttrack feature
...
class MysqlVisualExplainClienttrackFeature extends MysqlVisualExplainBaseFeature
{
    ...
    public function PostConstruct(MysqlVisualExplainContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'MysqlVisualExplain-SDK';
