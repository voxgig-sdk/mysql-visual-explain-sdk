...
// MysqlVisualExplain SDK SystemInfo entity
...
class SystemInfoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SystemInfoEntity($this->_client, $opts);
    }

    /**
     * @param SystemInfo|array $args SystemInfo data (assoc-array) to store.
     */
    ...
    /**
     * @return SystemInfo|array The current SystemInfo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SystemInfo fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SystemInfo fields).
     */
    ...
    /**
     * Load a single SystemInfo.
     *
     * @param SystemInfoLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SystemInfoLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SystemInfo|array The loaded SystemInfo as an assoc-array at the
