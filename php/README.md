...
The PHP SDK for the MysqlVisualExplain API. Provides an entity-oriented interface using PHP conventions.
...
```php
// Create
[$created, $_] = $client->QueryAnalysi(null)->create(["name" => "Example"], null);
...
[$result, $err] = $client->MysqlVisualExplain(null)->load(
    ["id" => "test01"], null
);
