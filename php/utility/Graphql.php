...
// MysqlVisualExplain SDK utility: graphql
//
...
class MysqlVisualExplainGraphql
{
    ...
    // equivalent.
    public static function body(MysqlVisualExplainContext $ctx): mixed
    {
    ...
    public static function errors(MysqlVisualExplainContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
