...
// MysqlVisualExplain SDK utility: result_basic

class MysqlVisualExplainResultBasic
{
    public static function call(MysqlVisualExplainContext $ctx): ?MysqlVisualExplainResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof MysqlVisualExplainError) ? $result->err->msg : (string)$result->err;
