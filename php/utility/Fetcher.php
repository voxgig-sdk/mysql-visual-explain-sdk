...
// MysqlVisualExplain SDK utility: fetcher

class MysqlVisualExplainFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MysqlVisualExplainSDK/1.0)';
    ...
    public static function call(MysqlVisualExplainContext $ctx, string $fullurl, array $fetchdef): array
    {
