...
// MysqlVisualExplain SDK pipeline test
//
...
{
    private static function utility(): MysqlVisualExplainUtility
    {
        return new MysqlVisualExplainUtility();
    }
    ...
    private static function ctx(array $over = []): MysqlVisualExplainContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MysqlVisualExplainContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MysqlVisualExplainOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MysqlVisualExplainError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MysqlVisualExplainOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MysqlVisualExplainMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MysqlVisualExplainOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MysqlVisualExplainMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MysqlVisualExplainOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MysqlVisualExplainMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MysqlVisualExplainSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MysqlVisualExplainMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MysqlVisualExplainResponse([]),
            'result' => new MysqlVisualExplainResult([]),
        ]);
        [, $err] = MysqlVisualExplainMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new MysqlVisualExplainSpec([]),
            'response' => null,
            'result' => new MysqlVisualExplainResult([]),
        ]);
        [, $err] = MysqlVisualExplainMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MysqlVisualExplainSpec(['step' => 's']),
            'response' => new MysqlVisualExplainResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MysqlVisualExplainResult([]),
        ]);
        [, $err] = MysqlVisualExplainMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MysqlVisualExplainSpec(['step' => 's']),
            'response' => new MysqlVisualExplainResponse(self::resp(200, ['v' => 1])),
            'result' => new MysqlVisualExplainResult([]),
        ]);
        [, $err] = MysqlVisualExplainMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MysqlVisualExplainSpec(['step' => 's']),
            'response' => new MysqlVisualExplainResponse(self::resp(200, ['v' => 2])),
            'result' => new MysqlVisualExplainResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MysqlVisualExplainMakeResponse::call($ctx);
    ...
    {
        $preset = new MysqlVisualExplainResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MysqlVisualExplainSpec([]),
            'response' => new MysqlVisualExplainResponse([]),
            'result' => new MysqlVisualExplainResult([]),
        ...
        [$got, $err] = MysqlVisualExplainMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MysqlVisualExplainResult([])]);
        [, $err] = MysqlVisualExplainMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MysqlVisualExplainSpec([]), 'result' => null]);
        [, $err] = MysqlVisualExplainMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MysqlVisualExplainSpec(['step' => 's']),
            'result' => new MysqlVisualExplainResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MysqlVisualExplainOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MysqlVisualExplainMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MysqlVisualExplainSpec(['step' => 's']),
            'result' => new MysqlVisualExplainResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MysqlVisualExplainOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MysqlVisualExplainMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MysqlVisualExplainResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MysqlVisualExplainSpec([]),
            'result' => new MysqlVisualExplainResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MysqlVisualExplainMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MysqlVisualExplainMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MysqlVisualExplainError('boom', 'boom');
        $utility->fetcher = function (MysqlVisualExplainContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MysqlVisualExplainSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MysqlVisualExplainMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MysqlVisualExplainContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MysqlVisualExplainMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MysqlVisualExplainResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        MysqlVisualExplainMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MysqlVisualExplainContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MysqlVisualExplainSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MysqlVisualExplainMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MysqlVisualExplainResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MysqlVisualExplainSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MysqlVisualExplainMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MysqlVisualExplainMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MysqlVisualExplainMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MysqlVisualExplainResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MysqlVisualExplainDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MysqlVisualExplainResult(['ok' => false])]);
        $this->expectException(MysqlVisualExplainError::class);
        MysqlVisualExplainDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MysqlVisualExplainResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MysqlVisualExplainMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        MysqlVisualExplainMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MysqlVisualExplainBaseFeature();
        $b = new MysqlVisualExplainBaseFeature();
        MysqlVisualExplainFeatureAdd::call($ctx, $a);
        MysqlVisualExplainFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MysqlVisualExplainBaseFeature
    {
        $f = new MysqlVisualExplainBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MysqlVisualExplainFeatureAdd::call($ctx, self::named_feature('a'));
        MysqlVisualExplainFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        MysqlVisualExplainFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        MysqlVisualExplainFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        MysqlVisualExplainFeatureAdd::call($ctx, $replace);
        ...
        MysqlVisualExplainFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): MysqlVisualExplainContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MysqlVisualExplainSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MysqlVisualExplainPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        MysqlVisualExplainPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MysqlVisualExplainResponse(['headers' => null]),
            'result' => new MysqlVisualExplainResult([]),
        ]);
        MysqlVisualExplainResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        MysqlVisualExplainResultBody::call($ctx);
