...
class SystemInfoEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set MYSQL_VISUAL_EXPLAIN_TEST_SYSTEM_INFO_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function system_info_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("MYSQL_VISUAL_EXPLAIN_TEST_SYSTEM_INFO_ENTID");
