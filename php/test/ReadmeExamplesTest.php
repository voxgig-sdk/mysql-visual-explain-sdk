...
// MysqlVisualExplain SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MysqlVisualExplainSDK::test)
...
{
    private const SDK_CLASS = 'MysqlVisualExplainSDK';
    ...
    private const SDK_BASE = 'mysqlvisualexplain_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../mysqlvisualexplain_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
