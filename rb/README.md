...
raise a `MysqlVisualExplainError` (a `StandardError` subclass), so wrap
...
```
rb/
├── MysqlVisualExplain_sdk.rb       -- Main SDK module
...
The main module (`MysqlVisualExplain_sdk`) exports the SDK class
