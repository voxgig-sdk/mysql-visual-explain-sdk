...
#      offline in seeded test mode (MysqlVisualExplainSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "MysqlVisualExplain_sdk.rb")
  SDK_CLASS = "MysqlVisualExplainSDK"
  ...
  SDK_BASE = "MysqlVisualExplain_sdk"
