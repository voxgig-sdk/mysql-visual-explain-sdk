...
class SystemInfoEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MYSQL_VISUAL_EXPLAIN_TEST_SYSTEM_INFO_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def system_info_basic_setup(extra)
  ...
  entid_env_raw = ENV["MYSQL_VISUAL_EXPLAIN_TEST_SYSTEM_INFO_ENTID"]
