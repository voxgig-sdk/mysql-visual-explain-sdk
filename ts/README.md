# MysqlVisualExplain TypeScript SDK

The TypeScript SDK for the MysqlVisualExplain API. Provides a type-safe, entity-oriented interface with full async/await support.
...
| `tester(testopts?, sdkopts?)` | `MysqlVisualExplainSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `MysqlVisualExplainSDK.test(testopts?, sdkopts?)` | `MysqlVisualExplainSDK` | Create a test-mode client. |
...
├── src/
│   ├── MysqlVisualExplainSDK.ts        # Main SDK class
