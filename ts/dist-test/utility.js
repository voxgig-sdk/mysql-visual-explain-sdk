...
function envOverride(m) {
    if ('TRUE' === process.env.MYSQL_VISUAL_EXPLAIN_TEST_LIVE ||
        'TRUE' === process.env.MYSQL_VISUAL_EXPLAIN_TEST_OVERRIDE) {
    ...
    m.MYSQL_VISUAL_EXPLAIN_TEST_EXPLAIN = process.env.MYSQL_VISUAL_EXPLAIN_TEST_EXPLAIN || m.MYSQL_VISUAL_EXPLAIN_TEST_EXPLAIN;
    return m;
}
