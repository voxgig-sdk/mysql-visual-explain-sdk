...
(0, node_test_1.describe)('SystemInfoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.MysqlVisualExplainSDK({
    ...
    (0, node_test_1.test)('direct-load-system_info', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-system_info', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.MYSQL_VISUAL_EXPLAIN_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MysqlVisualExplainSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['MYSQL_VISUAL_EXPLAIN_TEST_SYSTEM_INFO_ENTID'];
    ...
    const client = new __1.MysqlVisualExplainSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=SystemInfoDirect.test.js.map