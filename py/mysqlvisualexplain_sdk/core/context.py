...
from mysqlvisualexplain_sdk.core.helpers import get_ctx_prop, to_map
...
class MysqlVisualExplainContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = MysqlVisualExplainControl()
        ...
        if isinstance(sp, MysqlVisualExplainSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MysqlVisualExplainResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MysqlVisualExplainResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return MysqlVisualExplainOperation({})
    ...
    def make_error(self, code, msg):
        return MysqlVisualExplainError(code, msg, self)
