...
from mysqlvisualexplain_sdk.mysqlvisualexplain_types import (
    QueryAnalysi,
...
class QueryAnalysiEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return QueryAnalysiEntity(self._client, opts)
    ...
    def data_get(self) -> QueryAnalysi:
    ...
    def match_get(self) -> QueryAnalysi:
    ...
    def create(self, reqdata: QueryAnalysiCreateData, ctrl=None) -> QueryAnalysi:
        utility = self._utility
