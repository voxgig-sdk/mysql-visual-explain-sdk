...
from mysqlvisualexplain_sdk.utility import register

# Load features
from mysqlvisualexplain_sdk.feature.base_feature import MysqlVisualExplainBaseFeature
from mysqlvisualexplain_sdk.features import _has_feature, _make_feature
...
class MysqlVisualExplainSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = MysqlVisualExplainUtility()
        self._utility = utility

        from mysqlvisualexplain_sdk.config import shared_config
    ...
    def get_utility(self):
        return MysqlVisualExplainUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MysqlVisualExplainSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def QueryAnalysi(self, data=None) -> "QueryAnalysiEntity":
        ...
        from mysqlvisualexplain_sdk.entity.query_analysi_entity import QueryAnalysiEntity
    ...
    def SystemInfo(self, data=None) -> "SystemInfoEntity":
        ...
        from mysqlvisualexplain_sdk.entity.system_info_entity import SystemInfoEntity
