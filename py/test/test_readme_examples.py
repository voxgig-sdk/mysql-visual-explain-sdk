# MysqlVisualExplain SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MysqlVisualExplainSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MysqlVisualExplainSDK(...) and MysqlVisualExplainSDK.test(...) become
#      MysqlVisualExplainSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "mysqlvisualexplain_sdk"
_SDK_CLASS = "MysqlVisualExplainSDK"
