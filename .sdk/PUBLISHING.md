...
|---|---|---|
| `ts/` | @voxgig-sdk/mysql-visual-explain-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/mysql-visual-explain-sdk \
      --repository voxgig-sdk/mysql-visual-explain-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/mysql-visual-explain-sdk` shows it, and
`npm trust revoke @voxgig-sdk/mysql-visual-explain-sdk --id=<id>` removes it.
