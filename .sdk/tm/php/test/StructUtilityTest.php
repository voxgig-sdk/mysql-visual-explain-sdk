...
// MysqlVisualExplain SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = MysqlVisualExplainOmni::makeStructRunner(
    ...
    {
        return MysqlVisualExplainOmni::objmodel(MysqlVisualExplainOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return MysqlVisualExplainOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return MysqlVisualExplainOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(MysqlVisualExplainOmni::structfix($now, Struct::undef()))
                        !== json_encode(MysqlVisualExplainOmni::structfix($val, Struct::undef()))) {
