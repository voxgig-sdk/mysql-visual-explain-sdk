...
// MysqlVisualExplain SDK proxy feature
...
class MysqlVisualExplainProxyFeature extends MysqlVisualExplainBaseFeature
{
    ...
    public function init(MysqlVisualExplainContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MysqlVisualExplainContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
