...
// MysqlVisualExplain SDK ratelimit feature
...
class MysqlVisualExplainRatelimitFeature extends MysqlVisualExplainBaseFeature
{
    ...
    private function _acquire(MysqlVisualExplainContext $ctx): void
    {
    ...
    private function _track(MysqlVisualExplainContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
