...
// MysqlVisualExplain SDK rbac feature
...
class MysqlVisualExplainRbacFeature extends MysqlVisualExplainBaseFeature
{
    ...
    private function _required(MysqlVisualExplainContext $ctx): ?string
    {
    ...
    private function _reject(MysqlVisualExplainContext $ctx, string $required): void
    {
    ...
    private function _track(MysqlVisualExplainContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
