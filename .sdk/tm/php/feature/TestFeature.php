...
// MysqlVisualExplain SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MysqlVisualExplainTestFeature extends MysqlVisualExplainBaseFeature
{
    ...
    public function init(MysqlVisualExplainContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MysqlVisualExplainContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = MysqlVisualExplainParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MysqlVisualExplainContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MysqlVisualExplainContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = MysqlVisualExplainParam::call($ctx, $k);
