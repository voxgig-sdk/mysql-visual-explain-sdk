...
// MysqlVisualExplain SDK timeout feature
...
class MysqlVisualExplainTimeoutFeature extends MysqlVisualExplainBaseFeature
{
    ...
    private function _with_timeout(MysqlVisualExplainContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MysqlVisualExplainContext $_ctx, float $ms): void
    {
        $client = $this->client;
