...
// MysqlVisualExplain SDK utility type

class MysqlVisualExplainUtility
{
    ...
    public static function copy(MysqlVisualExplainUtility $src): MysqlVisualExplainUtility
    {
        $u = new MysqlVisualExplainUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
