...
// MysqlVisualExplain SDK utility: make_options

class MysqlVisualExplainMakeOptions
{
    ...
    public static function call(MysqlVisualExplainContext $ctx): array
    {
        ...
        //
        // `MysqlVisualExplainSchema::optspec()` is built from the model:
        ...
        $optspec = MysqlVisualExplainSchema::optspec();
