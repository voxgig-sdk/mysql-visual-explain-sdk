...
// MysqlVisualExplain SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MysqlVisualExplainMakeRequest
{
    public static function call(MysqlVisualExplainContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MysqlVisualExplainResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MysqlVisualExplainResponse($fetched);
        } else {
