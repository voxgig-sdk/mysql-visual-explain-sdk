// Command MysqlVisualExplain-cli is a CLI + REPL for the MysqlVisualExplain SDK,
...
const prompt = "mysql-visual-explain"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "query_analysi system_info"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      MYSQL_VISUAL_EXPLAIN_APIKEY (api key), MYSQL_VISUAL_EXPLAIN_BASE (base url override)")
