...
func registerSDKWords(r *eng.Registry, client *sdk.MysqlVisualExplainSDK) {
...
func runOp(client *sdk.MysqlVisualExplainSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
