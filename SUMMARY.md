...
Results: Successfully generated visual explanation.
...
- `mysqlVersion`: MySQL version for compatibility (for example, 8.0, 5.7)
...
Results: Successfully retrieved MySQL version.
...
| --- | --- | --- | --- |
| QueryAnalysi | `create` | `POST /api/explain` | See reference |
| SystemInfo | `load` | `GET /api/version` | See reference |

## Connect to the API

- Production server: `https://mysqlexplain.com`
...
- `mysql-visual-explain_list`: List records for an entity. No active entity supports this operation.
- `mysql-visual-explain_load`: Load one record for an entity. Supported entities: `system_info`.
