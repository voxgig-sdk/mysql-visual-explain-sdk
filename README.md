...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/mysql-visual-explain` | `npm install @voxgig-sdk/mysql-visual-explain` |
| Python | `voxgig-sdk-mysql-visual-explain` | `pip install voxgig-sdk-mysql-visual-explain` |
| PHP | `voxgig-sdk/mysql-visual-explain` | `composer require voxgig-sdk/mysql-visual-explain` |
| Golang | `github.com/voxgig-sdk/mysql-visual-explain-sdk/go` | `go get github.com/voxgig-sdk/mysql-visual-explain-sdk/go` |
| Ruby | `voxgig-sdk-mysql-visual-explain` | `gem install voxgig-sdk-mysql-visual-explain` |
| Lua | `voxgig-sdk-mysql-visual-explain` | `luarocks install voxgig-sdk-mysql-visual-explain` |
