...
type MysqlVisualExplainSDK struct {
	Mode     string
...
func (sdk *MysqlVisualExplainSDK) OptionsMap() map[string]any {
...
func (sdk *MysqlVisualExplainSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *MysqlVisualExplainSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *MysqlVisualExplainSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MysqlVisualExplainSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *MysqlVisualExplainSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *MysqlVisualExplainSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("MysqlVisualExplainSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *MysqlVisualExplainSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MysqlVisualExplainSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("MysqlVisualExplainSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *MysqlVisualExplainSDK {
	...
	sdk := NewMysqlVisualExplainSDK(sdkopts)
	sdk.Mode = "test"
