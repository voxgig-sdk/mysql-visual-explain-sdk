...
const testSeed = `map[string]any{"entity": map[string]any{"query_analysi": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "system_info": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
