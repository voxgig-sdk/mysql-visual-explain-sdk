...
import (
	...
	"github.com/voxgig-sdk/mysql-visual-explain-sdk/go/entity"
	"github.com/voxgig-sdk/mysql-visual-explain-sdk/go/feature"
	_ "github.com/voxgig-sdk/mysql-visual-explain-sdk/go/utility"
)
...
// instead of `sdk.NewMysqlVisualExplainSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *MysqlVisualExplainSDK  { return NewMysqlVisualExplainSDK(nil) }
func Test() *MysqlVisualExplainSDK { return TestSDK(nil, nil) }
