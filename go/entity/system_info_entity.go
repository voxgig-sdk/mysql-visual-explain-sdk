...
func NewSystemInfoEntity(client *core.MysqlVisualExplainSDK, entopts map[string]any) *SystemInfoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SystemInfoEntity) GetName() string { return e.name }
...
func (e *SystemInfoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SystemInfoEntity) Deleted() bool {
	return e.deleted
}


func (e *SystemInfoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSystemInfoEntity(e.client, opts)
}

func (e *SystemInfoEntity) Data(args ...any) any {
...
func (e *SystemInfoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SystemInfo; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SystemInfoEntity) DataTyped(data ...SystemInfo) SystemInfo {
	if len(data) > 0 {
		return typedFrom[SystemInfo](e.Data(asMap(data[0])))
	}
	return typedFrom[SystemInfo](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SystemInfo (all fields
// optional at the wire level).
func (e *SystemInfoEntity) MatchTyped(match ...SystemInfo) SystemInfo {
	if len(match) > 0 {
		return typedFrom[SystemInfo](e.Match(asMap(match[0])))
	}
	return typedFrom[SystemInfo](e.Match())
}
...
func (e *SystemInfoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SystemInfoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SystemInfoLoadMatch and returns an SystemInfo. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SystemInfoEntity) LoadTyped(reqmatch SystemInfoLoadMatch, ctrl map[string]any) (SystemInfo, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return SystemInfo{}, err
	}
	return typedFrom[SystemInfo](res), nil
}



func (e *SystemInfoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SystemInfoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SystemInfoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SystemInfoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SystemInfoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
