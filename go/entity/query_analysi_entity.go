...
type QueryAnalysiEntity struct {
	name    string
	client  *core.MysqlVisualExplainSDK
...
func NewQueryAnalysiEntity(client *core.MysqlVisualExplainSDK, entopts map[string]any) *QueryAnalysiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *QueryAnalysiEntity) GetName() string { return e.name }
...
func (e *QueryAnalysiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *QueryAnalysiEntity) Deleted() bool {
	return e.deleted
}


func (e *QueryAnalysiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewQueryAnalysiEntity(e.client, opts)
}

func (e *QueryAnalysiEntity) Data(args ...any) any {
...
func (e *QueryAnalysiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an QueryAnalysi; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *QueryAnalysiEntity) DataTyped(data ...QueryAnalysi) QueryAnalysi {
	if len(data) > 0 {
		return typedFrom[QueryAnalysi](e.Data(asMap(data[0])))
	}
	return typedFrom[QueryAnalysi](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through QueryAnalysi (all fields
// optional at the wire level).
func (e *QueryAnalysiEntity) MatchTyped(match ...QueryAnalysi) QueryAnalysi {
	if len(match) > 0 {
		return typedFrom[QueryAnalysi](e.Match(asMap(match[0])))
	}
	return typedFrom[QueryAnalysi](e.Match())
}
...
func (e *QueryAnalysiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *QueryAnalysiEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *QueryAnalysiEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *QueryAnalysiEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// QueryAnalysiCreateData and returns an QueryAnalysi. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *QueryAnalysiEntity) CreateTyped(reqdata QueryAnalysiCreateData, ctrl map[string]any) (QueryAnalysi, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return QueryAnalysi{}, err
	}
	return typedFrom[QueryAnalysi](res), nil
}



func (e *QueryAnalysiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *QueryAnalysiEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *QueryAnalysiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
