// Command MysqlVisualExplain-mcp is an MCP server exposing the MysqlVisualExplain
// SDK as MCP tools.
//
// Two tools are registered:
//
//	MysqlVisualExplain_list  — list records of an entity
//	MysqlVisualExplain_load  — load a single record of an entity
//
