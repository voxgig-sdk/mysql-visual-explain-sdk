...
type Args struct {
	Entity string         `json:"entity" jsonschema:"query_analysi | system_info"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.MysqlVisualExplainSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "mysql-visual-explain_list",
		Description: "List records from MysqlVisualExplain. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "mysql-visual-explain_load",
		Description: "Load a single record from MysqlVisualExplain. " +
...
func runOp(client *sdk.MysqlVisualExplainSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MysqlVisualExplainSDK, name string) (sdk.MysqlVisualExplainEntity, error) {
	switch strings.ToLower(name) {
	case "query_analysi":
		return client.QueryAnalysi(nil), nil
	case "system_info":
