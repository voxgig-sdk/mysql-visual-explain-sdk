...
local SystemInfoEntity = {}
SystemInfoEntity.__index = SystemInfoEntity


function SystemInfoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SystemInfoEntity)
...
function SystemInfoEntity:get_name()
  return self._name
end


function SystemInfoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SystemInfoEntity.new(self._client, opts)
end
...
function SystemInfoEntity:mark_deleted()
  self._deleted = true
end


function SystemInfoEntity:deleted()
  return true == self._deleted
end


function SystemInfoEntity:data_set(args)
  if args ~= nil then
...
function SystemInfoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SystemInfoEntity:match_set(args)
  if args ~= nil then
...
function SystemInfoEntity:match_get()
...
function SystemInfoEntity:stream(action, args, callopts)
...
---@param reqmatch SystemInfoLoadMatch
---@param ctrl? table
---@return SystemInfo
---@return string? err
function SystemInfoEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function SystemInfoEntity:_run_op(ctx, post_done)
  local utility = self._utility
