...
describe("QueryAnalysiEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MYSQL_VISUAL_EXPLAIN_TEST_QUERY_ANALYSI_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    query_analysi_ref01_data = helpers.to_map(type(query_analysi_ref01_data_result) == 'table' and query_analysi_ref01_data_result.data_get and query_analysi_ref01_data_result:data_get() or query_analysi_ref01_data_result)
...
function query_analysi_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MYSQL_VISUAL_EXPLAIN_TEST_QUERY_ANALYSI_ENTID")
