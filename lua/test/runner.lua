...
function runner.env_override(m)
  local live = runner.getenv("MYSQL_VISUAL_EXPLAIN_TEST_LIVE")
  local override = runner.getenv("MYSQL_VISUAL_EXPLAIN_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MYSQL_VISUAL_EXPLAIN_TEST_EXPLAIN")
