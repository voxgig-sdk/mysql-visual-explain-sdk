...
function runner.env_override(m)
  local live = runner.getenv("MYSQLVISUALEXPLAIN_TEST_LIVE")
  local override = runner.getenv("MYSQLVISUALEXPLAIN_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MYSQLVISUALEXPLAIN_TEST_EXPLAIN")
