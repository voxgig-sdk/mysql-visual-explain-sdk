...
describe("SystemInfoDirect", function()
  it("should direct-load-system_info", function()
    local setup = system_info_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-system_info", setup.live and "live" or "unit")
